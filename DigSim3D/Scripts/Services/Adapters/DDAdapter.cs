...
{
    /// <summary>
    /// Changes coordinate systems and generates Differntial Drive paths
    /// </summary>
    public static class DDAdapter
    {
        ...
        /// <summary>
        /// Computes the shortest Differential Drive path from passed start position to goal position
        /// </summary>
