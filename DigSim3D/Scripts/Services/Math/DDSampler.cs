namespace DigSim3D.Services
{
    ...
    /// <summary>
    /// Converts high-level path descriptions generated for a Differential Drive path into discrete 2D points
    /// </summary>
    public static class DdSampler
    {
        // startWorld: (x,y,thetaRadians) in world units; path normalized (R=1); R scales to world units
        /// <summary>
        /// Produces a piecewise-linear approximation of the entire path, with constant spacing ds
        /// </summary>
        ...
        /// <summary>
        /// Adds gear tracking to the SamplePolyline function
        /// </summary>
        /// <param name="startWorld"></param>
        /// <param name="path"></param>
        /// <param name="R"></param>
